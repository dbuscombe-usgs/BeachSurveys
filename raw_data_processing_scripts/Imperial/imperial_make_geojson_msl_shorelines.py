...
contour_dict = {'NARRABEEN':  {'MSL':  0,      'MHWS': 0.7  }, # survey datum is MSL
                ...
                'IMPERIAL':{'MSL':  0.774 , 'MHWS': 3.1}, # survey datum is NAVD88
...
fp_raw = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/imperial_mapped_sand_elevations/imperial_mapped_sand_elevations/"
transects_dir = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/ImperialBeachforZooSDS_paper_analysis/"
shoreline_dir = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/"
...
################################################################
transects_dir = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/ImperialBeachforZooSDS_paper_analysis"
shoreline_dir = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/ImperialBeachforZooSDS_paper_analysis/msl"
...
plt.subplot(312)
id = np.unique(joined_df.transect_id.values)[42]
y = joined_df[joined_df.transect_id.values==id]['cross_distance']
x = joined_df[joined_df.transect_id.values==id]['dates']
plt.plot(x,y,'k-', alpha=0.5)
plt.plot(x,y,'k.')
...
# plt.show()
plt.savefig('Imperial_MSL_timeseries_example.png', dpi=300, bbox_inches='tight')
plt.close()


joined_df.to_csv('Imperial_MSL_fieldsurvey_shoreline_chainage.csv')

joined_gdf = gpd.GeoDataFrame(
    joined_df, geometry=gpd.points_from_xy(joined_df.x, joined_df.y), crs="EPSG:4326"
)

joined_gdf.to_file("Imperial_MSL_fieldsurvey_shoreline_chainage.geojson", driver="GeoJSON") 
...
shoreline_dir = r"/media/marda/FOURTB/SDS/Zoo_SDS_paper/field_survey_data/ImperialBeach/ImperialBeachforZooSDS_paper_analysis/mhws"
...
# plt.show()
plt.savefig('ImperialBeach_MHWStimeseries_example.png', dpi=300, bbox_inches='tight')
plt.close()



joined_df.to_csv('ImperialBeach_MHWS_fieldsurvey_shoreline_chainage.csv')

joined_gdf = gpd.GeoDataFrame(
    joined_df, geometry=gpd.points_from_xy(joined_df.x, joined_df.y), crs="EPSG:4326"
)

joined_gdf.to_file("ImperialBeach_MHWS_fieldsurvey_shoreline_chainage.geojson", driver="GeoJSON") 
...
#################################################################################
### SLOPE
joined_gdf_MSL = gpd.read_file("Imperial_MSL_fieldsurvey_shoreline_chainage.geojson")
joined_gdf_MHW = gpd.read_file("Imperial_MHWS_fieldsurvey_shoreline_chainage.geojson")
...
df.to_csv('Imperial_fieldsurvey_slopes.csv')


plt.figure(figsize=(16,8))

plt.subplot(121)
plt.plot(np.linspace(0,83*50,83), df.mean(axis=0), label='mean')
plt.plot(np.linspace(0,83*50,83), df.median(axis=0), label='median')
...
plt.savefig('Imperial_slope_space_time.png',dpi=200, bbox_inches='tight')
plt.close()
...
plt.savefig('Imperial_Avslope_MonthOfYear.png',dpi=200, bbox_inches='tight')
plt.close()
...
plt.subplot(121)
plt.pcolormesh(np.arange(0,12), np.arange(0,83), np.vstack(MM), vmin=0.03, vmax=0.15)
plt.colorbar(extend='both')
plt.xlabel('Month of Year')
plt.ylabel('Transect ID')
plt.gca().invert_yaxis()
plt.savefig('Imperial_spacetime_monthly.png',dpi=200, bbox_inches='tight')
plt.close()
...
# contour = 'MHWS' #'MSL' # other option is 'MHWS'
# contour_level = contour_dict[sitename][contour]
# print('Extracting time-series using the %.1f m contour...'%(contour_level))
...
# df.to_csv('ImperialBeach_fieldsurvey_slopes.csv')
...
# df.to_csv('ImperialBeach_fieldsurvey_shoreline_chainage.csv')
